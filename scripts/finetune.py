"""
Based on Octo codebase (https://github.com/octo-models/octo/blob/main/examples/02_finetune_new_observation_action.py)
...
python scripts/finetune.py --pretrained_path=hf://rail-berkeley/octo-small --data_dir=... --save_dir=...
"""
...
def main(_):
    ...
    learning_rate = optax.join_schedules(
        ...
        [optax.linear_schedule(0, 2e-5, 100), optax.constant_schedule(2e-5)], [100]
    )
    ...
    for i in tqdm.tqdm(range(25000), total=25000, dynamic_ncols=True):
